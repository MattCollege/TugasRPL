<?php
// Sesuaikan ini dengan file koneksi Anda
@include 'koneksi.php';
...
if(isset($_POST['submit'])){
    ...
    if(mysqli_num_rows($result) > 0){
        ...
        if($row['user_type'] == 'manajer'){
            $_SESSION['loguser'] = "manajer";
            header('location:halaman_manajer.php');
        } elseif($row['user_type'] == 'pelayan'){
            $_SESSION['loguser'] = "pelayan";
            header('location:halaman_pelayan.php');
        } elseif($row['user_type'] == "pelanggan"){
            $_SESSION['loguser'] = "pelanggan";
